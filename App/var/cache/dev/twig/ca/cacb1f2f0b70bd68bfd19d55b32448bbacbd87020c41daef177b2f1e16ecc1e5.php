...
class __TwigTemplate_d8ec9d9070420cc86b650846f30de7c2aa6a4d6d9797f5160d86028ec21bbf69 extends \Twig\Template
{
    private $source;
    private $macros = [];
...
{% macro form_tree_details(name, data, forms_by_hash, show) %}
    ...
    {% endfor %}
{% endmacro %}
", "WebProfilerBundle:Collector:form.html.twig", "/var/www/html/App/vendor/symfony/web-profiler-bundle/Resources/views/Collector/form.html.twig");
    }
}
