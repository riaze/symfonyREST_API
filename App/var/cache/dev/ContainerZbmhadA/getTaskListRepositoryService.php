...
// Returns the private 'App\Repository\TaskListRepository' shared autowired service.
...
include_once $this->targetDirs[3].'/src/Repository/TaskListRepository.php';

return $this->privates['App\\Repository\\TaskListRepository'] = new \App\Repository\TaskListRepository(($this->services['doctrine'] ?? $this->getDoctrineService()));
