...
use FOS\RestBundle\Controller\AnnotationsasFOSRest;
...
class SecurityController extends FOSRestController
{
    ...
    public function__construct(ClientManagerInterface $client_manager){
...
public function AuthenticationAction(Request $request)
{
    ...
    if(empty($data['redirect-uri'] )|| empty($data['grant-type']))
    {
        ...
        $rows=['client_id'=>$client->getPublicId(),'client_secret'=>$client->getSecret()];
